  ...
  return (
    <footer className="bg-[#2A1B0A] text-[#D4AF37] border-t-2 border-[#D4AF37]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-[#D4AF37] text-center">
          <p>&copy; {new Date().getFullYear()} The Three Broomsticks. All rights reserved.</p>
          <p className="mt-2 text-sm">Magic provided by Madame Rosmerta</p>
        </div>
      </div>
    </footer>
  )
